...
/**
 * Created by S528748 on 10/27/2017.
 */
...
public class MyArrayAdapter extends ArrayAdapter {
     ...
     */
    public MyArrayAdapter(@NonNull Context context, @LayoutRes int resource, @IdRes int textViewResourceId, @NonNull List<User> objects) {
